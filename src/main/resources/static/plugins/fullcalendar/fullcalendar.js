...
var Grid = fc.Grid = RowRenderer.extend({
	...
	/* Fill System (highlight, background events, reconciliation hours)
	------------------------------------------------------------------------------------------------------------------*/
...
Grid.mixin({
	...
	// Generates an array of classNames to be used for the rendering reconciliation hours overlay. Called by the fill system.
...
TimeGrid.mixin({
	...
	// Repositions reconciliation hours segs too, so not just for events. Maybe shouldn't be here.
...
function EventManager(options) { // assumed to be a calendar
	...
	// Returns an array of events as to when the reconciliation hours occur in the given view.
	...
	function getBusinessHoursEvents() {
		...
		if (optionVal) {
			if (typeof optionVal === 'object') {
				// option value is an object that can override the default reconciliation hours
				eventInput = $.extend({}, defaultVal, optionVal);
			}
			else {
				// option value is `true`. use default reconciliation hours
